...
export default function OurStoryPage() {
  return (
    ...
    <ShowcaseSection
      ...
      <BenefitSection
        label="سنگ بنا"
        title="سنگ‌بنای گندم از یک دغدغه آغاز شد: "
      ...
      <section className={`${toneWrapper("violet")} mb-12`}>
        <div className="grid gap-6 md:grid-cols-1 items-center">
          ...
          <div className="leading-8 text-muted-foreground">
            ...
            <p>
                گروه حسابداری گندم با بهره گیری از تجربه، دانش و مهارت نیروی انسانی خود کلیه بخش های پایین دستی مربوط به حسابداری از ابتدا که کدینگ، سیستم حسابداری، انتخاب نرم افزار مالی تا رسیدن به گزارشات حسابداری مالی کسب و کار مخاطب خود را ایجاد، اصلاح و یا بهبود و بهینه سازی می نماید تا پس از آماده سازی این زیرساخت ها بخش حسابداری مدیریتی قابل اتکا بر این ساختار به درستی پایه گذاری گردد.
            </p>
            <p className="mt-4">
                داده های حاصل از حسابداری مدیریت، پس از تجزیه و تحلیل های اولیه در اختیار مدیران کسب و کار قرار می گیرند البته گروه حسابداری گندم آماده همراهی و ارائه خدمات مجدد در پردازش داده ها برمبنای بازخورد مدیران می باشد.
            </p>
            <p className="mt-4">
                علاوه بر این گروه حسابداری گندم خدمات مشاوره مدیریتی با بهره مندی از مدیران با تجربه را در صورت نیاز مخاطبین خود نیز ارایه می دهد که بعنوان خدماتی تکمیلی می تواند به رشد و موفقیت کسب و کارهای مخاطب خود کمک نماید.
             </p>
          </div>
