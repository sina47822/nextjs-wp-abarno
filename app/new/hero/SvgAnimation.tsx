...
export default function SvgAnimation() {
  ...
  return (
    <svg width="600px" height="500px" direction="ltr" className="hidden md:block absolute top-12 left-12">
      <text id="text1" x="40" y="200" fontSize="24" fill="white" className="font-dana">
        حسابداری
      </text>
      ...
      <rect id="rect4" x="260" y="260" rx="14" ry="25" width="120" height="60" fill="#7a663f25" />
    </svg>
  );
}
