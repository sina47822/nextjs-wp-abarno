...
export default function SvgAnimation() {
  ...
  return (
    <svg width="600px" height="500px" direction="ltr" className="absolute top-12 left-12">
      <text id="text1" x="40" y="200" fontFamily="Tahoma" fontSize="24" fill="white">
        حسابداری
      </text>
      ...
      <text id="text2" x="250" y="100" fontFamily="Tahoma" fontSize="24" fill="white">
        سیستماتیک
      </text>
      ...
      <text id="text3" x="290" y="200" fontFamily="Tahoma" fontSize="24" fill="white">
        امن
      </text>
      ...
      <text id="text4" x="270" y="300" fontFamily="Tahoma" fontSize="24" fill="white">
        تطبیقی
      </text>
